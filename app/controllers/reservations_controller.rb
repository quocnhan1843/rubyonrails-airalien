class ReservationsController < ApplicationController
	...
	def create
		...
		if @reservation
			...
			values = {
				business: 'study.rubyonrails-facilitator@gmail.com',
				cmd: '_xclick',
				upload: 1,
				notify_url: 'https://rubyonrails-airalien.herokuapp.com/notify',
				amount: @reservation.total,
				item_name: @reservation.room.listing_name,
				item_number: @reservation.id,
				quantity: '1',
				return: 'https://rubyonrails-airalien.herokuapp.com/your_trips'
			}
